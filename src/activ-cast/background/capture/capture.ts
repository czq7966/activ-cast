...
export class Capture {
    static chooseDesktopMediaHandle: number;
    static getDesktopStream(screenOptions: Array<ECaptureScreenOptions>,  callback: (stream: MediaStream, tab?: chrome.tabs.Tab) => void) {
    ...
    static getTabStream(callback: (stream: MediaStream, tab: chrome.tabs.Tab) => void) {
        var constraints: any = {}
    ...
    static cancelChooseDesktopMedia() {
